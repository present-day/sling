...
# QBO MCP server lives in a sibling repo during dev:
git clone https://github.com/intuit/quickbooks-online-mcp-server ../quickbooks-online-mcp-server
(cd ../quickbooks-online-mcp-server && bun install && bun run build)
```

Add a `MCP_QBO_SERVER_PATH` env var pointing at `../quickbooks-online-mcp-server/dist/index.js`.
...
MCP_QBO_SERVER_PATH=../quickbooks-online-mcp-server/dist/index.js
